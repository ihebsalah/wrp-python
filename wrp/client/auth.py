...
from wrp.client.streamable_http import WRP_PROTOCOL_VERSION
from wrp.shared.version import LATEST_PROTOCOL_VERSION
...
class OAuthContext:
    ...
    def should_include_resource_param(self, protocol_version: str | None = None) -> bool:
        ...
        - WRP-Protocol-Version header is 2025-06-18 or later
        """
...
class OAuthClientProvider(httpx.Auth):
    ...
    async def _discover_protected_resource(self, init_response: httpx.Response) -> httpx.Request:
        ...
        return httpx.Request("GET", url, headers={WRP_PROTOCOL_VERSION: LATEST_PROTOCOL_VERSION})
    ...
    async def _handle_token_response(self, response: httpx.Response) -> None:
        ...
        try:
            ...
            if token_response.scope and self.context.client_metadata.scope:
                ...
                unauthorized_scopes = (returned_scopes - requested_scopes) - {"openid"}
    ...
    async def async_auth_flow(self, request: httpx.Request) -> AsyncGenerator[httpx.Request, httpx.Response]:
        ...
        async with self.context.lock:
            ...
            self.context.protocol_version = request.headers.get(WRP_PROTOCOL_VERSION)
