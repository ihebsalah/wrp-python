...
WRP_PROTOCOL_VERSION_HEADER = "wrp-protocol-version"
...
def cors_middleware(
    ...
    cors_app = CORSMiddleware(
        ...
        allow_headers=[MCP_PROTOCOL_VERSION_HEADER, WRP_PROTOCOL_VERSION_HEADER, "content-type", "authorization", "x-requested-with"],
    )
    return cors_app
