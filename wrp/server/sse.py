...
This module implements a Server-Sent Events (SSE) transport layer for WRP servers.
...
class SseServerTransport:
    """
    SSE server transport for WRP. This class provides _two_ ASGI applications,
