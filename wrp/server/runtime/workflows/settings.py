# wrp/server/runtime/workflows/settings.py
...
class WorkflowSettings(BaseModel):
    ...
    def settings_overridden(self, *, ctx: "Context | None" = None, workflow: str | None = None) -> bool:  # type: ignore[name-defined]
        """
        ...
        if ctx is not None:
            ...
            if wf_name:
                return bool(ctx.wrp._workflow_manager.settings_overridden(wf_name))  # canonical
